...
export default class TextEditor extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="RichEditor-root container-fluid" 
                style={{ 
                    background: "#fff",  
...
const BlockStyleControls = props => {
    ...
    return (
        <div className="btn-toolbar RichEditor-controls" role="toolbar" > 
            <div className="btn-group btn-group-sm" role="group" aria-label="text-size-mod" style={{marginRight:"5px", marginBottom:"5px"}} >
                {
