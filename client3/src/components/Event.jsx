...
const Event = ({ data, getPosts, createPost, updatePost, deletePost, user }) => {
  let type = BOARD_TYPE.EVENT.NAME;
  let isAllowed = BOARD_TYPE.EVENT.EDIT.includes(!isEmpty(user) ? user.role.toUpperCase() : 'ADMIN');
