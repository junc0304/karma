...
const Meeting = ({ data, getPosts, createPost, updatePost, deletePost, user }) => {
  let type = BOARD_TYPE.MEETING.NAME;
  let isAllowed = BOARD_TYPE.MEETING.EDIT.includes(!isEmpty(user) ? user.role.toUpperCase() : 'ADMIN');
